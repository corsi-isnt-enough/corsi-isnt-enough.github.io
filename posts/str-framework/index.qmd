...
#| code-fold: true
#| label: chart-top15
#| fig-cap: "Top 15 teams by composite STR. Positive values indicate above-average combined special teams performance."
...
# ax.set_title(f'Special Teams Rating — Top Teams')
# plt.tight_layout()
# plt.show()
```
...
#| code-fold: true
#| label: chart-buckets
#| fig-cap: "League-average PP Goals/60 broken down by score state. The non-uniformity across buckets is the empirical case for stratification."

# fig, ax = plt.subplots(figsize=(8, 5))
# ax.bar(league_pp.index, league_pp['goals_per_60'], color=bar_colors)
# ax.set_ylabel('PP Goals per 60 minutes')
# ax.set_title('League-Average PP Goals/60 by Score State')
# plt.tight_layout()
# plt.show()
```

::: {.callout-note}
Charts require running the full notebook locally or via the repo — the NHL API is live data and outputs will vary by sample size and season. See [GitHub](https://github.com/corsi-isnt-enough/nhl-analytics) for the full executable notebook.
:::
